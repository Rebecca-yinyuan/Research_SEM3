...
subplot(1, 3, 1)
opt = append(color, '--');
plot(t_m(1 : index + 1), S_m(1 : index + 1), color); hold on
...
subplot(1, 3, 2)
plot(t_m(1 : index + 1), V_m(1 : index + 1), color); hold on
xline(t_decade, '-.','LineWidth', 1.2); hold on
%xl = xline(t_decade, '-.', 'S = 0', 'LineWidth', 1.2); hold on
%xl.LabelHorizontalAlignment = 'left';
%xl.LabelVerticalAlignment = 'middle';
...
subplot(1, 3, 3)
plot(t_m(1 : index + 1), T_m(1 : index + 1), color); hold on
xline(t_decade, '-.','LineWidth', 1.2); hold on
%xl = xline(t_decade, '-.', 'S = 0', 'LineWidth', 1.2); hold on
%xl.LabelHorizontalAlignment = 'left';
%xl.LabelVerticalAlignment = 'middle';
...
subplot(1, 3, 1)
opt = append(color,'--');
plot(t_m(index - 10 : index + 8), S_m(index - 10 : index + 8), color); hold on
plot(t_m(index - 10 : index + 8), I_m(index - 10 : index + 8), opt); hold on
xline(t_decade, '-.','LineWidth', 1.2); hold on
xline(t_decade, '-.', 'LineWidth', 1.2); hold on
%xl.LabelHorizontalAlignment = 'left';
%xl.LabelVerticalAlignment = 'middle';
...
subplot(1, 3, 2)
plot(t_m(index - 10 : index + 8), V_m(index - 10 : index + 8), color); hold on
xline(t_decade, '-.', 'LineWidth', 1.2); hold on
%xl = xline(t_decade, '-.', 'S = 0', 'LineWidth', 1.2); hold on
%xl.LabelHorizontalAlignment = 'left';
%xl.LabelVerticalAlignment = 'middle';
...
subplot(1, 3, 3)
plot(t_m(index - 10 : index + 8), T_m(index - 10 : index + 8), color); hold on
xline(t_decade, '-.', 'LineWidth', 1.2); hold on
%xl = xline(t_decade, '-.', 'S = 0', 'LineWidth', 1.2); hold on
%xl.LabelHorizontalAlignment = 'left';
%xl.LabelVerticalAlignment = 'middle';
